...
#define DP_PI (3.1415)	// pi - changed
...
double const tansixthpi=0.577350269189626;		// tan(pi/6), used in atan routines
double const twelfthpi=DP_PI/12.0;			// pi/12.0, used in atan routines
double const tantwelfthpi=0.267949192431123;	// tan(pi/12), used in atan routines
...
{
	const float c1= 0.9994;
	const float c2=-0.4955;
	const float c3= 0.0367;
