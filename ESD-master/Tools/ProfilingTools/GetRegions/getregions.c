/*
* Program to analyze ELF files to generate table of function address ranges (region tables) 
* and list of functions with sizes.
* 3/14/2017 A.G.Dean, agdean@ncsu.edu
*
* Based on sample program to print the names of ELF sections.
